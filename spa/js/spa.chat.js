spa.chat = (function (){
  ...
  var
    configMap = {
      ...
      slider_opened_em: 18,
      slider_closed_em: 2,
      slider_opened_mmin_em: 10,
      window_height_min_em: 20, 
      slider_opened_title: "Top to close",
      slider_closed_title: "Top to open",
  ...
  setPxSizes = function(){
    ...
    opened_height_em =
      window_height_em > configMap.window_height_min_em ? configMap.slider_opened_em : configMap.slider_opened_mmin_em
    
    stateMap.px_per_em = px_per_em;
    stateMap.slider_closed_px = configMap.slider_closed_em * px_per_em;
    stateMap.slider_opend_px = opened_height_em * px_per_em;
    jqueryMap.$sizer.css({
  ...
  setSliderPosition = function(position_type, callback){
    ...
    switch(position_type){
      case "opened": 
        height_px = stateMap.slider_opend_px;
    ...
    jqueryMap.$slider.animate(
      {height: height_px}, animate_time, function(){
  ...
  handleResize = function(){
    ...
    setPxSizes();
    if( stateMap.position_type === "opened"){
      jqueryMap.$slider.css({height: stateMap.slider_opend_px});
    }
    return true;
  };
